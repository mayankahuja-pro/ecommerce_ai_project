...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "store.price_similarity",
        "sources": [
            "price_similarity.pyx"
        ]
    },
    "module_name": "store.price_similarity"
}
END: Cython Metadata */
...
#define __PYX_HAVE__store__price_similarity
#define __PYX_HAVE_API__store__price_similarity
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "store.price_similarity" */
...
#define __Pyx_MODULE_NAME "store.price_similarity"
extern int __pyx_module_is_main_store__price_similarity;
int __pyx_module_is_main_store__price_similarity = 0;

/* Implementation of "store.price_similarity" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5store_16price_similarity_compute_similarity(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_prices, double __pyx_v_avg_price); /* proto */
...
#define __pyx_n_u_prices __pyx_string_tab[22]
#define __pyx_n_u_qualname __pyx_string_tab[23]
#define __pyx_n_u_scores __pyx_string_tab[24]
#define __pyx_n_u_set_name __pyx_string_tab[25]
#define __pyx_n_u_setdefault __pyx_string_tab[26]
#define __pyx_n_u_store_price_similarity __pyx_string_tab[27]
...
#define __pyx_kp_b_iso88591_F_32V1A_U_1_auCq_as_A_1 __pyx_string_tab[31]
...
/* Python wrapper */
static PyObject *__pyx_pw_5store_16price_similarity_1compute_similarity(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_5store_16price_similarity_1compute_similarity = {"compute_similarity", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5store_16price_similarity_1compute_similarity, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5store_16price_similarity_1compute_similarity(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_prices,&__pyx_mstate_global->__pyx_n_u_avg_price,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "compute_similarity", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("compute_similarity", 1, 2, 2, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
    ...
    __pyx_v_avg_price = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_avg_price == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_similarity", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("store.price_similarity.compute_similarity", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_prices), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "prices", 0))) __PYX_ERR(0, 4, __pyx_L1_error)
  __pyx_r = __pyx_pf_5store_16price_similarity_compute_similarity(__pyx_self, __pyx_v_prices, __pyx_v_avg_price);
...
static PyObject *__pyx_pf_5store_16price_similarity_compute_similarity(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_prices, double __pyx_v_avg_price) {
  int __pyx_v_i;
  int __pyx_v_n;
  ...
  __pyx_pybuffernd_prices.rcbuffer = &__pyx_pybuffer_prices;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_prices.rcbuffer->pybuffer, (PyObject*)__pyx_v_prices, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 4, __pyx_L1_error)
  }
...
*/
    ...
    __pyx_t_11 = fabs(((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_prices.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_prices.diminfo[0].strides)) - __pyx_v_avg_price)); 
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_pybuffernd_scores.diminfo[0].shape;
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_pybuffernd_scores.diminfo[0].shape)) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 10, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_scores.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_scores.diminfo[0].strides) = __pyx_t_11;
  }

  /* "store/price_similarity.pyx":12
 *         scores[i] = abs(prices[i] - avg_price)
 * 
 *     return scores             # <<<<<<<<<<<<<<
*/
...
static int __pyx_pymod_exec_price_similarity(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_price_similarity},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_price_similarity(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_price_similarity(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_price_similarity(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'price_similarity' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "price_similarity" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_price_similarity", 0);
  ...
  if (__pyx_module_is_main_store__price_similarity) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "store.price_similarity")) {
      if (unlikely((PyDict_SetItemString(modules, "store.price_similarity", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef int i, n = prices.shape[0]
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_